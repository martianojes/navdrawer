...
public class ActivityListRecyclerViewAdapter extends RecyclerView.Adapter<ActivityListRecyclerViewAdapter.ViewHolder> {
    ...
    private final ArrayList<Activity> mValues;
    private final ListFragmentActivity.OnListFragmentInteractionListener mListener;

    public ActivityListRecyclerViewAdapter(ArrayList<Activity> items, ListFragmentActivity.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.expandable_list_activity, parent, false);
